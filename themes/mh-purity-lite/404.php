	...
	<div class="main">
		<section class="content <?php mh_content_class(); ?>">
			...
			<div class="entry sb-widget">
				<p><?php _e('It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'mhp'); ?></p>
				<?php get_search_form(); ?>
			</div>
			<div class="sb-widget home-2 home-wide"><?php
				$instance = array('title' => __('Latest Articles', 'mhp'), 'postcount' => '5', 'sticky' => 1);
