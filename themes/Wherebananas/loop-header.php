...
<a href=/><img src="http://wherebananas.sinkjuice.com/wp-content/uploads/sites/7/2014/11/wherebananas-728by901.png" width="728" height="90" /></a>
...
if( is_search() ) {
	?>
	<h4 class="title-search-results"><?php printf( __( 'Search results for: %s', 'responsive' ), '<span>' . get_search_query() . '</span>' ); ?></h4>
<?php
}
